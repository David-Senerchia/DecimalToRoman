...
class FlexibleIntegerToRomanTest {
    ...
    void testArabicToRoman() {
        ...
        assertEquals( "Integer must be greater than 0", FlexibleIntegerToRoman.arabicToRoman(0));
        assertEquals( "Integer must be greater than 0", FlexibleIntegerToRoman.arabicToRoman(-1));
