...
class InflexibleIntegerToRomanTest {
    ...
    void testArabicToRoman() {
        ...
        assertEquals( "Integer must be between 1 and 4999", InflexibleIntegerToRoman.arabicToRoman(5000));
        assertEquals( "Integer must be between 1 and 4999", InflexibleIntegerToRoman.arabicToRoman(0));
        assertEquals( "Integer must be between 1 and 4999", InflexibleIntegerToRoman.arabicToRoman(-1));
